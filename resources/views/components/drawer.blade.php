...
>
    ...
    <div
        ...
        class="bg-white dark:bg-gray-800 dark:text-gray-100 h-screen overflow-y-auto w-full md:w-2/3 xl:w-1/2 absolute top-0 right-0 transform duration-200 ease-in-out z-50 p-4 rounded-l-xl sm:p-10"
    >
        {{ $slot }}
    </div>
</div>
